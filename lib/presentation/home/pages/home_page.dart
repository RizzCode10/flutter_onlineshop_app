...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    context.read<SpecialOfferProductBloc>().add(const SpecialOfferProductEvent
        .getSpecialOfferProducts()); // context.read<AllProductBloc>().add(const AllProductEventtAllProducts());
    super.initState();
  }
